...
def home_page(l):
 ...
 if d:
  ...
  decision_showcase=f'<article class="showcase-select">{safe_visual}{safe_text}</article><div class="commerce-extras">{light_feature}<div class="compact-grid">'+compact2('revenue','/media/decision/revenue_goodmorning.svg','AP Revenue — GOOD MORNING 10월 10일 예약 페이스',d['revenue'])+compact2('travel','/media/inbound_frame.jpg','AP Travel',d['travel'])+'</div></div>'
 else:
